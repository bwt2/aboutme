...
export default function Footer() {
  return (
    <footer className={styles.footer}>
      <ul>
        <li>
          <a target="_blank" href="https://drive.google.com/file/d/1y1aH3RzyXaTUzEVXViHX_JCVAKLXojXB/view?usp=drive_link">
          <svg fill="#FFFFFF" height="40" width="40" viewBox="0,0,512,512">
            <g transform="scale(0.9, 0.9), translate(30, 40)">
              <g>
                <g>
